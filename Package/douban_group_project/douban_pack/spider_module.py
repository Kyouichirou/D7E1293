...
class Spider:
    ...
    def _control(self):
        ...
        th.daemon = True
        th.start()
        print('[info]: key monitor has been started')
    ...
    def __start_scheduler(self, interval_time: int):
        if self._exit_flag:
            return
        ...
        print('[info]: scheduler has been started')
    ...
    def start(self, interval_time: int):
        ...
        self._control()
        self.__catalog_page()
        self.__start_scheduler(interval_time)
